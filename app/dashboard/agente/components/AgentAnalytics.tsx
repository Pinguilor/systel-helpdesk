...
export default function AgentAnalytics({ tickets }: Props) {
    ...
    return (
        <div className="space-y-6 mb-8 px-4 sm:px-0">
            {/* KPI Cards Row - REDISEÑADO PARA 3 COLUMNAS EN MÓVIL */}
                                    ...
                                    {modalData.data.map(ticket => (
                                        ...
                                        >
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <span className={`text-[10px] sm:text-xs font-bold px-2 py-0.5 rounded-full border uppercase tracking-wider ${ticket.estado === 'resuelto' ? 'bg-emerald-50 text-emerald-700 border-emerald-200' :
